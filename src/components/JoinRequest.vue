<template>
    <div class="wrapper">
      <div v-if="isRequestSentToViewingTeam" class="ui teal disabled button">Join Request Sent</div>
      <div v-if="!isRequestSentToViewingTeam" class="ui teal button" @click="showForm">Join Request</div>
      <div class="ui modal">
...
export default {
  ...
  computed:{
    ...mapGetters(['isRequestSentToViewingTeam'])
  },
     methods:{
         showForm : () => {
            $('.ui.modal')
        ...
        /* es6 arrow function is the kind of anonymous function which "this" cannot be access*/
         sendForm : function() {
             this.$store.dispatch('request/sendJoinTeamRequest',{message:this.message});
           swal({
